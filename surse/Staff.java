...
public abstract class Staff<T extends Comparable<T>> extends User<T> implements StaffInterface {
    ...
    public Staff(Information information, AccountType accountType, String username, int experience,
                 List<String> notifications, SortedSet<T> favorites, List<Request> assignedRequests, SortedSet<T> contributions) {
    ...
    public void addContribution(T item) {
    ...
    public void addMovie() {
        ...
        while (scanner.hasNextLine()) {
            ...
            ratings.add(new Rating(username, rating, comment, imdb.searchUser(username).getAccountType()));
        }
